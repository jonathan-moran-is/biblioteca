<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {!! $errors->first('details', '<div class="invalid-feedback">:message</div>') !!}66
        </div>
        <div class="form-group">
            {{ Form::label('price') }}
        ...
        <div class="form-group">
            ...
            {{ Form::text('shipping_cost', $product->shipping_cost, ['class' => 'form-control' . ($errors->has('shipping_cost') ? ' is-invalid' : ''), 'placeholder' => 'Discount']) }}
